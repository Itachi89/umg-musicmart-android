...
public abstract class MusicMartAsyncTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> {
	...
	public MusicMartAsyncTask(MusicMartApplication application){
