...
/**
 * Created by varunsundaramoorthy on 4/21/14.
 */
public class LoadMoreListTask extends MusicMartAsyncTask<Long, Void, List<SalesRecord>> {

    private MusicMartActivity activity;

    public LoadMoreListTask(MusicMartActivity activity) {
